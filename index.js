...
function sortStockPriceByDescendingOrder(stock1, stock2) {
  return stock2.price - stock1.price;
}

function sortStockPriceByAscendingOrder(stock1, stock2) {
  return stock1.price - stock2.price;
}

function sortGrowthInDescendingOrder(stock1, stock2) {
  return stock2.growth - stock1.growth;
}

function sortGrowthInAscendingOrder(stock1, stock2) {
